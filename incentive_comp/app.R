# incentive survey (FINAL - for competition)
# Sam Bacon
...
server <- function(input, output) {
    ...
    output$incentiveCode <- renderText({
        ...
        keyLocation <- gs4_get('https://docs.google.com/spreadsheets/d/1muizTy8l-ACoe8QTK9DYdgJLhd4cMONLyRlR8l5P7Ig/edit#gid=1690470092')
        ...
        if(nchar(input$codeInput) == 0){
            ...
            if(input$submit){
                ss <- gs4_get('https://docs.google.com/spreadsheets/d/1muizTy8l-ACoe8QTK9DYdgJLhd4cMONLyRlR8l5P7Ig/edit#gid=1690470092')
